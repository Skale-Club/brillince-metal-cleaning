  ...
  return (
    <div className="container-custom mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          <div className="website-cta-soft mb-6 inline-flex items-center gap-2 rounded-full border px-3 py-1 text-sm font-medium">
          ...
          {sectionContent?.ctaText ? (
            <div className="mb-4">
              <button
                ...
                className="website-cta rounded-full px-4 py-2 text-sm font-bold hover:-translate-y-0.5"
              >
                {sectionContent.ctaText}
